    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="p-6 md:p-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <button
                onClick={startCamera}
                className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg transition duration-200 flex items-center"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-gray-700">Active Zones</span>
                </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-gray-700">Alerts Today</span>
                </div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.1 }}
          className="mt-8 bg-white shadow-xl rounded-2xl p-6 border border-gray-200"
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-50 p-5 rounded-lg">
              <div className="text-blue-500 text-2xl font-bold mb-3">01</div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Capture Images</h3>
            ...
            <div className="bg-gray-50 p-5 rounded-lg">
              <div className="text-blue-500 text-2xl font-bold mb-3">02</div>
            ...
            <div className="bg-gray-50 p-5 rounded-lg">
              <div className="text-blue-500 text-2xl font-bold mb-3">03</div>
